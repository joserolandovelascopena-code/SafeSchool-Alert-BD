...
-- 1.1.1. CONSULTA 1: Registro de 7 posibles emergencias que pudieran suceder en la institución educativa.
   ...
   VALUES 
	 ...
	 (2, 2, 2, 'Medica,Edif_B,Activa', 'Estudiante herido en la cancha central del Edificio B', 'ACTIVA', '04:30:00', '2026-09-01'),
	 ...
	 (3, 2, 1, 'Medica,Edif_A,Activa', 'Desmayo de alumno en Primer Año Sección "A" del Edificio A', 'FALSA', '15:10:00', '2026-08-28'),
	 (1, 1, 2, 'Incendio,Edif_B,Activa', 'Humo detectado cerca del laboratorio principal en Edificio B', 'ATENDIDA', '15:10:00', '2026-08-28'),
	 (3, 2, 2, 'Medica,Edif_B,Activa', 'Estudiante lesionado en la cancha.', 'FALSA', '05:10:00', '2026-08-24');
